...
<div className="margin-vertical--double">
  <HeroCriticalImage
    src="/images/case-studies/ipsos/facto/cover_xsm.jpg"
    alt="IPSOS Facto AI Platform - Hero Demo with Blur Loading"
    className="image--max-width"
    placeholderColor="#2c3e50"
  />
  <p className="text--caption text--center">_Hero image with blur loading effect (high priority)_</p>
</div>
...
<LazyImage
  src="/images/case-studies/ipsos/facto/templates.gif"
  alt="Templates screen design"
  className="image--max-width"
  placeholderColor="#e8f5e8"
  style={{ aspectRatio: '16/9', objectFit: 'cover' }}
/>
...
<LazyImage
  src="/images/case-studies/ipsos/facto/tools.gif"
  alt="Tools design"
  className="image--max-width"
  placeholderColor="#f0f8ff"
  style={{ aspectRatio: '16/9', objectFit: 'cover' }}
