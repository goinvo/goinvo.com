...
caption: 'How design helps the public sector address challenges and increase resident engagement and accessibility.'
categories:
  - 'open-source'
...
hidden: false
references:
metaDescription: 'How design helps the public sector address challenges and increase resident engagement and accessibility.'
---
...
![Illustration of CMS Journey map](/images/case-studies/public-sector/cms_futurestate.jpg)
_Journey map on the future state for CMS's Medicaid Marketplace._
...
<p class="text--gray margin-top--none margin-bottom--none">The GoInvo studio has worked on numerous projects for government agencies, including:</p>
  <ul class="margin-top--none">
    <li><a href="https://goinvo.com/work/all-of-us/">The National Institutes of Health (NIH)</a></li>
    <li>The Centers for Medicare and Medicaid Services (CMS)</li>
    <li><a href="https://goinvo.com/work/mass-snap/">The Department of Transitional Assistance (DTA) for MA</a></li>
    <li>The Department of Unemployment Assistance (DUA) for MA</li>
  </ul>

<p class="text--black margin-top--double margin-bottom--none">
...
_Digitized SNAP application process increased accessibility for more residents to be able to apply for food benefits._
...
<p class="margin-top--double margin-bottom--double">  
  ![Image of a SNAP statistics](/images/case-studies/public-sector/pubDesign_stats_oct_2024.jpg)
</p>
...
![Image of SNAP DTA meeting](/images/case-studies/mass/snap/snap-dta-meeting.jpg)
_GoInvo designers getting feedback from a stakeholder and user group on our designs for the SNAP application process._
...
![Images of Common Health app](/images/case-studies/commonhealth/common_health_hero.jpg)
_GoInvo designs for SMART Health Cards for the CommonHealth application as a response for post-pandemic needs to be able to verify vaccination records._
...
![Image of MITRE Open Health Dashboard](/images/case-studies/mitre/state-of-us-healthcare/mitre_open_health_dashboard_demo.jpg)
_The MITRE Health Lab needed a large-scale, national healthcare storytelling service, to show public health officials, researchers, and policy makers the the data on the ground._
