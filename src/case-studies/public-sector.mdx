...
Designing for the public sector involves a set of unique challenges. There’s a long road between what exists now and such optimal services. So what stands in the way? The software landscape for government often consists of complex systems, diverse user needs, daunting regulatory requirements, and limited resources.
...
The design team encountered significant obstacles with existing policies that dictated phrasing of application questions. For instance,  accusatory wording and two-in-one combined inquiries  could deter or confuse applicants. Although the policy team collaborated with GoInvo to improve these issues, we found that many changes could not be implemented due to rigid policy requirements deeply ingrained in the system. This necessitated ongoing collaboration with the Department of Transitional Assistance (DTA) to navigate these constraints while still striving for a more user-friendly design.

#### Balancing Diverse Stakeholder Perspectives
Another challenge was managing the diverse perspectives of various stakeholders involved in the project. Different teams had distinct priorities — ranging from technical constraints to policy requirements — which sometimes led to misalignment in project goals. GoInvo had to facilitate discussions among stakeholders to ensure that user experience remained a priority throughout the design process. Our team adopted strategies like small group discussions and hands-on prototyping sessions to gather feedback effectively and foster rich dialogue among participants.

#### Accessibility Compliance
Ensuring that the application met accessibility standards was a critical challenge. GoInvo committed to making the application compliant with WCAG (Web Content Accessibility Guidelines) and Section 508 standards, which required careful consideration of design elements such as color contrast, screen reader compatibility, and overall usability for people with disabilities. This focus on accessibility not only improved user experience but also aligned with broader public sector mandates for inclusivity.

#### Iterative Design Process
The iterative nature of the design process posed its own set of challenges. While continuous testing and feedback loops are essential for refining designs, they can also lead to complications if stakeholder feedback is inconsistent or if project timelines are tight. Our team adapted by creating prototypes that allowed stakeholders to interact with the design early on, helping to clarify expectations and gather actionable insights more efficiently.
