      ...
      <div className="pure-g">
        {
          columns.map((_, i) => {
            return (
              <div key={i} className={`categories-list__column pure-u-1 pure-u-lg-1-${this.props.columns}`}>
                <ul className={`categories-list ${ i > 0 && this.props.includeAll ? 'categories-list--later-column-with-all' : '' }`}>
                  {
