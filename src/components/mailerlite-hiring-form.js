...
class MailerLiteHiringForm extends Component {
  ...
  //         "upload": e.target.elements.upload.value,
  //       },
  //       "ml-submit": 1,
  //       "anticsrf": true
  //     })
    ...
    return (
      <div className="hiring-form">
        <Helmet>
          ...
          <script src="https://cdn.jotfor.ms/js/vendor/imageinfo.js?v=3.3.62799" type="text/javascript"></script>
          <script src="https://cdn.jotfor.ms/file-uploader/fileuploader.js?v=3.3.62799" type="text/javascript"></script>
        ...
        <Card>
          <form 
                          ...
                          <div className="jfUpload-files-container">
                            <div className="validate[multipleUpload]">
                              <input 
                                ...
                                data-file-accept="pdf, doc, docx, txt, rtf, html, jpg, jpeg, png, gif"
                                accept="pdf, doc, docx, txt, rtf, html, jpg, jpeg, png, gif" 
                                data-limit-file-size="Yes" 
            ...
            <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="251193306087052" />
          </form>
        </Card>
      </div>
    )
