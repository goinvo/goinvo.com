        ...
        <BackgroundImage src="/images/contact/studio.jpg" gradient>
          <div className="pad-vertical--quad pad--only-lg">
            <div className="background--white max-width max-width--md content-padding--double pad-vertical--quad">
              ...
              <p>
                <span className="text--bold">First and foremost, you need to be exceptional:</span><br/>
              ...
              <p>
                <span className="text--bold">Second, you need to be a system thinker and serial do’er:</span><br/>
              ...
              <p>
                <span className="text--bold">Third, you have to really care about Design, your fellow staff, and Spaceship Earth:</span><br/>
              ...
              <p>That’s the kind of person we want. If you have those three qualities, just about anything else is negotiable.</p>
              <p>If you have any questions about the position, please email me.</p>
              <p>You can apply below, or send me your resume, portfolio, and phone number so we can chat.</p>
              <p>
                Looking forward,<br/>
