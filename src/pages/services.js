      ...
      <div className="pure-g pad-bottom--double">
        <div className="pure-u-1 pure-u-lg-1-2 pad-right--only-lg margin-bottom--double pad-vertical--double--only-lg">
          ...
          <p className="text--gray margin-top--half">
            ...
            challenges both seen and unseen. At GoInvo, we’ve focused solely on
            this space for over a decade, designing more than 110 products and
        ...
        <div className="pure-u-1 pure-u-lg-1-2 pad-left--only-lg margin-bottom--double pad-vertical--double--only-lg">
          ...
          <p className="text--gray margin-top--half">
            We bring fresh ideas and a history of healthcare design and research
            to help our clients leverage emerging technologies, envision future
            products and services, and realize long-term goals.
          </p>
          <Link
            to="/work/hgraph/"
        ...
        <div className="pure-u-1 pure-u-lg-1-2 pad-right--only-lg margin-bottom--double">
          ...
          <p className="text--gray margin-top--half">
            At GoInvo, you’ll get a dedicated design team that collaborates with
            you throughout the course of your project, communicating openly and
            adapting quickly to new challenges. We’re adept at integrating our
            design efforts with your engineering and product teams to form a
            seamless whole.
          </p>
        ...
        <div className="pure-u-1 pure-u-lg-1-2 pad-left--only-lg margin-bottom--double">
          ...
          <p className="text--gray margin-top--half">
            From enterprise-grade health IT to data-driven precision healthcare,
            GoInvo works closely with our clients and partners to transform
            messy problems into structured strategy and solutions.
          </p>
          <Link
            to="/work/mitre-shr"
            className="display--inline-block margin-right--double"
          ...
          <Link to="/work/partners-insight" className="display--inline-block">
