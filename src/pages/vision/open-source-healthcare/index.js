            ...
            <div className="max-width max-width--md content-padding">
              <div className="oshc-title-area">
                ...
                <p className="text--gray">
                  ...
                  While it first began with computer code, open source now
                  influences how projects and businesses work, and our lives
                  benefit from this open sharing. Open source has grown into a
                  way of participating with many others that asks for
                  transparency, community-based collaboration, and meritocracy.
                  The best ideas float to the top, and you earn trust by what
                  you do and how you amplify the group.
                </p>
                <p className="text--gray">
                  Our internet is infused with open source ideas and services
                  &mdash;from how cell phones communicate, to how e-mail is
                  directed from one person to the next, to Linux. All of these
                  technologies working together are the operating system of the
                  internet.
                </p>
                <p className="text--gray">
                ...
                <p className="text--gray">
                  ...
                  healthcare system invents its own way &mdash;to the detriment
              ...
              <div className="oshc-introduction">
                ...
                <div className="button-group margin-bottom--double">
                  <div className="pure-u-1 pure-u-lg-1-2">
                    <a
                      href="https://www.dropbox.com/s/ozixx5mmki3xcvi/opensourcehealthcare_journal.pdf?dl=0"
                      target="_blank"
                      rel="noopener noreferrer"
