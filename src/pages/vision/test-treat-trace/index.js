            ...
            <div className="max-width max-width--md content-padding">
              <References
                references={[
                  {
                    title:
                      'All State View of Week to Week Change in Percentage of Positive Tests: JHU Coronavirus Resource Center. Retrieved 1 June 2020',
                    link:
                      'https://coronavirus.jhu.edu/testing/individual-states',
                  },
                  {
                    title:
                      'HarvardGlobalHealth. (2020, May 25). HGHI and NPR publish new state testing targets. Retrieved 1 June 2020',
                    link:
                      'https://globalepidemics.org/2020/05/07/hghi-projected-tests-needed-may15/',
                  },
                  {
                    title:
                      'Management of Patients with Confirmed 2019-nCoV. (2020, May 20). Retrieved 1 June 2020 (archived link)',
                    link:
                      'https://web.archive.org/web/20200601114046/https://www.cdc.gov/coronavirus/2019-ncov/hcp/clinical-guidance-management-patients.html',
                  },
                  {
                    title:
                      'Simmons-Duffin, S. (2020, May 7). States Nearly Doubled Plans For Contact Tracers Since NPR Surveyed Them 10 Days Ago. Retrieved 2020 May 29',
                    link:
                  ...
                  {
                    title:
                      "Stein, R., Wroth, C., & Hurt, A. (2020, May 7). U.S. Coronavirus Testing Still Falls Short. How's Your State Doing? Retrieved 1 June 2020",
                    link:
                  ...
                  {
                    title:
                      'Swanson, I., & Leonhardt, M. (2020, May 5). WarnerRobins.com. Retrieved 1 June 2020 (original source no longer available)',
                    link:
                      'https://www.warnerrobins.com/2020/05/05/free-covid-19-testing-available-at-museum-of-aviation/',
                  },
                  {
                    title:
                      'TeamSafe. About TeamSafe. Retrieved 1 June 2020 (original source no longer available)',
                    link: 'https://www.teamsa.fe/',
                  },
                  {
                    title:
                      "The National Association of County and City Health Officials' Position Statement on Public Health Capacity for COVID-19 Contact Tracing Surge. Retrieved 1 June 2020  (original source no longer available)",
                    link:
                      'https://www.naccho.org/uploads/downloadable-resources/NACCHO-Contact-Tracing-Statement.pdf',
                  },
                  {
                    title: 'Contact tracing. (n.d.). Retrieved 1 June 2020',
                    link:
